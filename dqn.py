...
class DQN():
  ...
  def build_net(self, path, add=0):
    ...
    if add:
      ...
      W1_add_random = self.weight_variable(W1_add_zero.shape)
      W2_add_random = self.weight_variable(W2_add_zero.shape)
      b2_add_random = self.bias_variable(b2_add_zero.shape)
